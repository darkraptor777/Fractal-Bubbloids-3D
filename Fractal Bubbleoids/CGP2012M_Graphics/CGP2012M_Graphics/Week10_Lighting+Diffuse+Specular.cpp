...
glm::mat4 sphereRotate;
glm::mat4 sphereTranslate;
...
int main(int argc, char *argv[]) {
	...
	Model sphereModel;
	//create model loader
	//ModelImport cubeLoader; 
	//cubeLoader.LoadOBJ2("..//..//Assets//Models//blenderCube.obj", cubeModel.vertices, cubeModel.texCoords, cubeModel.normals, cubeModel.indices);
	ModelImport sphereLoader;
	sphereLoader.LoadOBJ2("..//..//Assets//Models//blenderSphere.obj", sphereModel.vertices, sphereModel.texCoords, sphereModel.normals, sphereModel.indices);
	...
	//cubeModel.setBuffers();

	sphereModel.setBuffers();
	...
	sphereScale = glm::mat4(1.0f);
	sphereRotate = glm::mat4(1.0f);
	sphereTranslate = glm::mat4(1.0f);
	...
	sphereTranslate = glm::translate(cubeTranslate, glm::vec3(0.0f, 0.0f, 0.0f));
